...
export async function POST(req: Request) {
  try {
    ...
    const { data: createdRepo } = await octokit.repos.createForAuthenticatedUser({
      ...
      private: true,
      auto_init: true,
      description: "hey green dots chasers , this project is just a joke, real learning happens when you're actually coding, not playing pixel art with your commit history. Stay focused, stay coding, and stop being a sheep! 🐑",
    });
